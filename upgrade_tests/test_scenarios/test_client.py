...
def update_product_subscription_in_ak(product, yum_repo, ak, org):
    ...
    :param str product: products name to calcualte subscription id
...
class Scenario_upgrade_old_client_and_package_installation(TestCase):
    ...
    ak_name = 'scenario_old_client_package_install'
    package_name = 'shark'
    prod_name = 'preclient_scenario_product'
    le_lable = le_name = '{}_le'.format(prod_name)
...
class Scenario_upgrade_new_client_and_package_installation(TestCase):
    ...
    """
    docker_vm = os.environ.get('DOCKER_VM')
    org_name = 'new_client_package_install'
    ak_name = 'scenario_new_client_package_install'
    le_name = ak_name+'_env'
    package_name = 'shark'
    prod_name = 'postclient_scenario_product'
